...
## 命令模式的角色
>  ![结构图](https://github.com/jiachao23/jcohy-study-sample/blob/master/jcohy-study-designpattern/images/command.png)
>  *  Command</br>
>  用来声明 执行操作的接口
...
## 命令模式的实现
                         ...
                         7.result
                         ![result](https://github.com/jiachao23/jcohy-study-sample/blob/master/jcohy-study-designpattern/images/result.png)
