...
> * [jdk10新特性一览](#Features)
> * [局部变量类型推断](#局部变量类型推断)
> * [整合 JDK 代码仓库](#整合JDK代码仓库)
> * [统一的垃圾回收接口](#统一的垃圾回收接口)
> * [并行全垃圾回收器 G1 ](#并行全垃圾回收器G1 )
> * [应用程序类数据共享](#应用程序类数据共享)
> * [线程-局部管控](#线程-局部管控)
> * [移除 Native-Header 自动生成工具](#移除Native-Header自动生成工具)
> * [额外的 Unicode 语言标签扩展](#额外的Unicode语言标签扩展)
> * [备用存储装置上的堆分配](#备用存储装置上的堆分配)
> * [基于 Java 的 实验性 JIT 编译器](#基于Java的实验性JIT编译器)
> * [根证书认证](#根证书认证)
